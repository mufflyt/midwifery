...
**These clipped figures are superseded.** They predate the mask-inversion
gate, so the clip was subtracting five state outlines (AR, IA, KS, MO, WV)
as though they were water. See the inversion-gate entry below for the
corrected numbers and the reasoning: water removed at 30 minutes fell from
180,809 km2 to 7,448 km2, and the surface grew from 1,578,621 km2 to
1,751,982 km2. Re-verified by rebuilding the map on 2026-08-10.
