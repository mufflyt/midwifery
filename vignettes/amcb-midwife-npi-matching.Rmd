...
and every exclusion to `artifacts/exclusion_ledger.rds` (non-negotiable #15) --
`.rds`, because `log_exclusion()` serialises with `saveRDS()`. The same table
is also written as `artifacts/exclusion_ledger.csv` for anyone reaching for it
by extension.
