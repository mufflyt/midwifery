#!/usr/bin/env python3
# =============================================================================
# ARCHIVED -- superseded by run_midwifery_microsimulation.R (repo root)
# =============================================================================
# Archived 2026-08-28. The R port is now the maintained, canonical
# implementation; this file is kept, not deleted, because it is the pinned
# oracle that tests/test_run_midwifery_microsimulation.R cross-checks the R
# port against (both must agree exactly for the real 12,211-provider
# baseline across all 15 simulated years) -- see docs/ADVERSARIAL_LOOP_
# LEDGER.md, Cycle 24, for the population-conservation fix both
# implementations share. Do not add new features here; add them to the R
# version and re-verify agreement, or this file stops being a useful oracle.
# =============================================================================
#
