...
# strip_med_suffix() lives in R/lib/training_institution.R, because the Trilliant
# directory carries the same CMS medical-school strings and must be cleaned by
# the same rule (enrich_trilliant_demographics.R).
source(file.path("R", "lib", "training_institution.R"))
