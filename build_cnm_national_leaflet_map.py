    ...
    <script>
        ...
        function updateMap() {{
            ...
            const markers = filtered.map(m => {{
                ...
                const mapsUrl = `https://www.google.com/maps/search/?api=1&query=${{encodeURIComponent(m.facility + ' ' + m.address + ' ' + m.city + ' ' + m.state + ' ' + m.zip)}}`;
                const openPaymentsUrl = `https://openpaymentsdata.cms.gov/physician/${{m.npi}}`;
                ...
                const popupContent = `
                    ...
                    <div class="popup-sub">
                        <a href="${{mapsUrl}}" target="_blank" style="color: #cbd5e1; text-decoration: underline;">🏥 ${{m.facility}}</a>
                    </div>
                    ...
                    <div class="popup-detail">
                        ...
                        <b>Practice Address:</b> <a href="${{mapsUrl}}" target="_blank" style="color: #94a3b8; text-decoration: underline;">${{m.address}}, ${{m.city}}, ${{m.state}} ${{m.zip}}</a><br>
